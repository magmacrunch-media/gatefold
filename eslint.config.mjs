...
//
// Three kinds of file:
//   app/        classic scripts attaching to window.Gatefold — sourceType
...
const browser = {
    ...
    // The canvas editor's own surface: Path2D for the clip art, the drag and
    // paste events for image import, File for what they carry.
    Path2D: 'readonly', File: 'readonly', DragEvent: 'readonly', btoa: 'readonly',
    ClipboardEvent: 'readonly', DataTransfer: 'readonly',
    Gatefold: 'writable', MagmaKit: 'readonly',
    // shell/ is vendored from the website repo and linted there, but the app
    // calls into both of these.
    Toast: 'readonly', RetroDropdown: 'readonly',
};
